...
{
public:
    Sprint(int keybind = Keyboard::NONE, bool enabled = false) :
        Module("Sprint", "Movement", "Sprint automatically", keybind, enabled)
    {
        registerBoolSetting("OmniSprint", "Automatically sprint backwards too", &omni);
    }
