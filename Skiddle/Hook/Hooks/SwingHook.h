...
public:
    ...
    bool Initialize() override {
        void* swingSpeedAddr = findSig(xorstr_("48 89 5C 24 ?? 57 48 83 EC ?? 48 8B 15 ?? ?? ?? ?? 48 8B F9")); //1.20.51
        void* addr = findSig(xorstr_("48 89 5c 24 ? 55 56 57 48 83 ec ? 8b 41 ? 48 8b ea 48 8b 49")); //1.20.51
